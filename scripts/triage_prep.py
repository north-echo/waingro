...
KNOWN_SAFE_DOMAINS = {
    ...
    "gist.githubusercontent.com", "api.github.com", "cli.github.com",
    ...
    "rpm.nodesource.com", "fnm.vercel.app",
    "pypi.org", "files.pythonhosted.org", "bootstrap.pypa.io",
    "install.python-poetry.org", "astral.sh", "pyenv.run",
    "rust-lang.org", "rustup.rs", "static.rust-lang.org", "sh.rustup.rs",
    "get.docker.com", "download.docker.com",
    "deno.land", "bun.sh",
    "releases.hashicorp.com", "apt.releases.hashicorp.com",
    "getcomposer.org", "get.helm.sh",
    "sdkman.io", "get.sdkman.io",
    "install.julialang.org", "repo.anaconda.com",
    "get.volta.sh",
    ...
    "cli.inference.sh",
    "nvidia.com",
    # Verified ecosystem services (high-frequency in ClawHub corpus)
    "openclaw.ai", "get.openclaw.ai",
    "skillboss.co",
    "cursor.com",
    "rclone.org",
    ...
    "resend.com",
    "claude.ai",
    # Placeholder / example domains (not malicious, just documentation)
